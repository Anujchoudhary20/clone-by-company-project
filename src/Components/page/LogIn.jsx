      ...
      <div className='bg-gray-300 rounded-md  py-5  px-10'>
        <strong className='my-4 flex justify-center font-bold text-2xl'>Log In</strong>
          ...
          <div className="flex  flex-col w-96 justify-center">
            {/* email Input */}
            <label className='text-2xl font-bold text-gray-600'>Email</label>
            <input
              type="email"
              placeholder="Email"
              ...
              className='w-full h-10 text-black my-3 rounded-md text-2xl px-2'
              required
            />
            {/* password  input*/}
            <label className='text-2xl font-bold text-gray-600'>Password</label>
            <input
              type="password"
            ...
            />
            {/* forgot Password */}
            <label className='text-2xl font-bold  text-gray-600'>
